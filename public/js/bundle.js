...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibW9lZ3lpNzciLCJhIjoiY2w2c3k0eWVsMG1hbDNmbzdjamo5eHgzbCJ9.arPfKgxztIQEmO1U_mQv7w';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/moegyi77/cl6szw28e000d14lf2gf6z95g',
    // style URL
    //   center: [95.9013753, 16.8396098],
    scrollZoom: false,
    zoom: 5 //   interactive: false
...
exports.signup = exports.resetPassword = exports.forgetPassword = void 0;
...
var resetPassword = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(password, confirmPassword) {
    var queryString, urlParams, token, res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Successfully posted your review');
              window.setTimeout(function () {
                location.reload(true);
              }, 1500);
            }
...
var updateReview = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(tourId, reviewId, review, rating) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3000/api/v1/tours/".concat(tourId, "/reviews/").concat(reviewId),
              data: {
                review: review,
                rating: rating
              }
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Successfully updated your review');
              window.setTimeout(function () {
                location.reload(true);
              }, 1500);
            }
  ...
  return function updateReview(_x4, _x5, _x6, _x7) {
    return _ref2.apply(this, arguments);
  };
}();
...
var deleteReview = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://localhost:3000/api/v1/reviews/".concat(reviewId)
            });
          ...
          case 3:
            ...
            if (res.status = 204) {
              (0, _alerts.showAlert)('success', 'Successfully deleted your review');
              window.setTimeout(function () {
                location.reload(true);
              }, 1500);
            }
  ...
  return function deleteReview(_x8) {
    return _ref3.apply(this, arguments);
  };
}();
...
var stripe = Stripe('pk_test_51LXfiGAOdhYXpYAGIqoAtOZvrOlbglz17gQzVXCaP5gKQovIkC8BRqEKmzqi1qakAnWa8nJIVbod86kbjJM0YQA400hbKrxBs4');

var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId, dateId, participants) {
    var session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:3000/api/v1/bookings/checkout-session/".concat(tourId, "/dateId/").concat(dateId, "/participants/").concat(participants));
...
var ratingStar = document.querySelectorAll('.rating__star');
var reviewForm = document.querySelector('.form--review');
var logOutBtn = document.querySelector('.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var callBookBtn = document.getElementById('call-book-modal');
var bookBtn = document.getElementById('book-btn');
var deleteReviewEl = document.querySelectorAll('.delete__review');
var tourDateSelectBox = document.getElementById('tour-date-select');
var tourParticipantsSelectBox = document.getElementById('tour-participants-select'); //Values
//Delegation
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return (0, _signup.forgetPassword)(email);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 6;
              return (0, _signup.resetPassword)(password, confirmPassword);
...
if (reviewForm) {
  ratingStar.forEach(function (element, index) {
    element.addEventListener('mouseover', function (e) {
      for (var i = 0; i <= index; i++) {
        ratingStar[i].classList.add('rating__star--active');
      }

      for (var j = index + 1; j < ratingStar.length; j++) {
  ...
  reviewForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
      var btnText, rating, review, tourId, reviewId;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              e.preventDefault();
              btnText = document.querySelector('.post-review').textContent;
            ...
            case 6:
              rating = document.querySelectorAll('.rating__star--active').length;
              review = document.getElementById('review-text').value;
              tourId = document.getElementById('review-text').getAttribute('data-tour-id');
              ...
              reviewId = document.getElementById('review-text').getAttribute('data-review-id');
              document.querySelector('.post-review').textContent = 'Updating...';
              _context4.next = 14;
              return (0, _review.updateReview)(tourId, reviewId, review, rating);
...
if (deleteReviewEl) {
  deleteReviewEl.forEach(function (element, index) {
    element.addEventListener('click', /*#__PURE__*/function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
        var reviewId, parentNode;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 7;
                return (0, _review.deleteReview)(reviewId);
...
if (callBookBtn) callBookBtn.addEventListener('click', function (e) {
...
if (tourDateSelectBox) {
  tourDateSelectBox.addEventListener('change', function (e) {
    var _JSON$parse = JSON.parse(tourDateSelectBox.dataset.tour),
        tour = _JSON$parse.tour;

    var _JSON$parse2 = JSON.parse(tourDateSelectBox.value),
        dateId = _JSON$parse2.value;

    var _tour$startDates$filt = tour.startDates.filter(function (dateObj) {
      return dateObj._id === dateId;
    }),
        tourDate = Object.assign({}, _tour$startDates$filt);

    var participants = tourDate[0].participants;
    var maxGroupSize = tour.maxGroupSize;
    var remainingBook = maxGroupSize - participants;
    var html = "";
    ...
    if (remainingBook < 1) {
      ...
      for (var index = 1; index <= remainingBook; index++) {
        html += "<option value=".concat(index, ">").concat(index, "</option>");
      }
    }
...
if (bookBtn) {
  bookBtn.addEventListener('click', /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(e) {
      var _JSON$parse3, dateId, participants, _JSON$parse4, tour, tourId;
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              _context6.prev = 0;
              _JSON$parse3 = JSON.parse(tourDateSelectBox.value), dateId = _JSON$parse3.value;
              participants = tourParticipantsSelectBox.value;
              _JSON$parse4 = JSON.parse(tourDateSelectBox.dataset.tour), tour = _JSON$parse4.tour;
              tourId = tour._id;
              console.log(dateId);
              bookBtn.textContent = 'Booking...';
              _context6.next = 9;
              return (0, _stripe.bookTour)(tourId, dateId, participants);
            ...
            case 11:
              ...
              return _context6.abrupt("return", (0, _alerts.showAlert)('error', 'Please Select The Tour Date And The Participants Numbers '));
